package me.hardcoded.smreader.utils;
...
public class TileUtils {
	...
	public static void error(String format, Object... args) {
		if (isDev()) {
			LOGGER.log(Log.Level.ERROR, 0, format, args);
		}
	...
	public static void log(String format, Object... args) {
		if (isDev()) {
			LOGGER.log(Log.Level.INFO, 0, format, args);
		}
	}
	
	public static void warn(String format, Object... args) {
		LOGGER.log(Log.Level.WARNING, 0, format, args);
	}
