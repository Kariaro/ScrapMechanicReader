...
public class DecompressTestingVersion4 {
	private static final int[] INT_00e6cab8 = { 0, 1, 2, 1, 0, 4, 4, 4 };
	private static final int[] INT_00e6cbe0 = { 0, 0, 0, 1, 4,-1,-2,-3 };
	...
	private int DecompressJava(final byte[] input, final byte[] param_2, final int size) {
		...
		do {
			...
			// System.out.printf("RB:%02x, IDX:%08x, ESI:%08x, EDI:%08x\n", readByte, index, ESI, EDI);
			...
			if(highByte < 8) {
				...
				// INT_00e6cab8 = { 0, 1, 2, 1, 0, 4, 4, 4 };
				// INT_00e6cbe0 = { 0, 0, 0, 1, 4,-1,-2,-3 };
				...
				*/
				...
				// This means that EDI and ESI is super close together
				EDI = ESI - highByte;
				memcpy(param_2, ESI + 0x0, param_2, EDI, 4);
				EDI += INT_00e6cab8[highByte];
